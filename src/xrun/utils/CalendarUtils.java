...
public class CalendarUtils {
  ...
  private static final int[] STARTS     = new int[] {
      5, 0, 1, 2, 3, 5, 6, 0, 1, 3, 4, 5, 6, 1, 2, 3, 4, 6, 0, 1, 2, 4, 5, 6, 0, 2, 3, 4, 5, 0, 1, 2, 3, 5, 6, 0, 1, 3,
      4, 5, 6, 1, 2, 3, 4, 6, 0, 1, 2, 4, 5, 6, 0, 2, 3, 4, 5, 0, 1, 2, 3, 5, 6, 0, 1, 3, 4, 5, 6, 1, 2, 3, 4, 6, 0, 1,
      2, 4, 5, 6, 0, 2, 3, 4, 5, 0, 1, 2, 3, 5, 6, 0, 1, 3, 4, 5, 6, 1, 2, 3, 4, 5, 6, 0, 1, 3, 4, 5, 6, 1, 2, 3, 4, 6,
      0, 1, 2, 4, 5, 6, 0, 2, 3, 4, 5, 0, 1, 2, 3, 5, 6, 0, 1, 3, 4, 5, 6, 1, 2, 3, 4, 6, 0, 1, 2, 4, 5, 6, 0, 2, 3, 4,
      5, 0, 1, 2, 3, 5, 6, 0, 1, 3, 4, 5, 6, 1, 2, 3, 4, 6, 0, 1, 2, 4, 5, 6, 0, 2, 3, 4, 5, 0, 1, 2, 3, 5, 6, 0, 1, 3,
      4, 5, 6, 1, 2, 3, 4, 6, 0, 1, 2
  };
  ...
  public static final int[] identifyWeek(int day, int month, int year, String[] out) { // result - week number, week start day, week start month
    ...
    if (day > diff) {
      ...
      return new int[] {
          weekNumber, day - diff, month
      };
    }
    int[] res = new int[] {
        weekNumber, (isLeap && month == 3 ? 29 : LENS[month - 2]) - (diff - day), month - 1
    };
