...
public class ChartUtils {
  ...
  private static final int[]    BOUNDS_DIST     = new int[] {
      0, 4, 5, 6, 7, 8, 10,
      12, 15, 20, 30, 40, 50
  };
  private static final double[] BOUNDS_SPEED    = new double[] {
      0, 4, 5, 6, 9,
      10, 11, 11.5, 12, 12.5, 13, 13.5, 14, 14.5, 15, 16
  };
  private static final int[]    BOUNDS_ELE      = new int[] {
      0, 250, 500, 1000, 1300,
      1500, 1800, 2000, 2500, 3000
  };
  private static final int[]    BOUNDS_RUNDIST  = new int[] {
      0, 4, 5, 6, 7, 8, 10,
      12, 15, 20, 30, 40, 50
  };
  private static final double[] BOUNDS_DURATION = new double[] {
      0, 0.25, 0.5,
      0.66, 0.83333, 1, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10
  };
  private static final int[]    BOUNDS_HOUR     = new int[] {
      0, 8, 9, 10, 12, 15, 18,
      19, 20
  };
