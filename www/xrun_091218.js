...
function initContent(data, skipCache) {
	...
	$('#overall tbody').html('<tr><td>Distance</td><td>' + data['totalDistance'] + " km</td><tr><td>Time</td><td>" + data['totalTime'] + '</td><tr><td>Average speed</td><td>' + data['avgSpeed'] + ' km/h</td></tr>' +
		...
		'<tr><td>Elevation gain</td><td>' + data['elePos'] + ' m</td></tr><tr><td>Elevation loss</td><td>' + data['eleNeg'] + ' m</td></tr><tr><td>HITP distance</td><td>' + data['totalRunDist'] + ' km</td></tr>');
	if (data['WMT'] != 'none') {
	...
	if (isAllTrail) {
		$('#runs tr:eq(0) th:eq(7)').html("HITP&nbsp;&nbsp;");
	} else {
	...
	$.each(all, function (i, item) {
		...
		$('#data' + i).append(extLinks + '<hr>' + parentSeg + dashboardTags + descrHtml + linksHtml + '<ul><li></li>' + '<table><tbody><tr><td>Date</td><td>' + item['startAt'] + '</td></tr><tr><td>Distance</td><td>' +
			...
			'HITP</td><td>' + (isMod ? '<em>' : '') + item['timeRunning'] + (isMod ? '*</em>' : '') + '</td></tr><tr><td>HITP distance</td><td>' + (isMod ? '<em>' : '') +
			item['distRunning'] + (isMod ? '*</em>' : '') + '</td></tr><tr><td>HITP elevation gain</td><td>' +
			'<span class="green">' + (isMod ? '<em>' : '') + item['eleRunningPos'] + (isMod ? '*</em>' : '') + '</span></td></tr><tr><td>HITP elevation loss</td><td>' +
...
function fetch(getWMTotals) {
	...
	if ($('#overallBtn').length == 0) {
		$('#overallLoader').html('<div class="sk-cube-grid"><div class="sk-cube sk-cube1"></div><div class="sk-cube sk-cube2"></div><div class="sk-cube sk-cube3"></div><div class="sk-cube sk-cube4"></div><div class="sk-cube sk-cube5"></div><div class="sk-cube sk-cube6"></div><div class="sk-cube sk-cube7"></div><div class="sk-cube sk-cube8"></div><div class="sk-cube sk-cube9"></div></div>');
	}
	$('#runs').hide();
	$('#ht').html('<div class="sk-cube-grid"><div class="sk-cube sk-cube1"></div><div class="sk-cube sk-cube2"></div><div class="sk-cube sk-cube3"></div><div class="sk-cube sk-cube4"></div><div class="sk-cube sk-cube5"></div><div class="sk-cube sk-cube6"></div><div class="sk-cube sk-cube7"></div><div class="sk-cube sk-cube8"></div><div class="sk-cube sk-cube9"></div></div>');
	$('#pagerMenu').hide();
...
function getBest() {
	...
	if ($('#bestOfBtn').length == 0) {
		$('#bestOfLoader').html('<div class="sk-cube-grid"><div class="sk-cube sk-cube1"></div><div class="sk-cube sk-cube2"></div><div class="sk-cube sk-cube3"></div><div class="sk-cube sk-cube4"></div><div class="sk-cube sk-cube5"></div><div class="sk-cube sk-cube6"></div><div class="sk-cube sk-cube7"></div><div class="sk-cube sk-cube8"></div><div class="sk-cube sk-cube9"></div></div>');
	}
	$.ajax({
		url: 'best',
		method: 'POST',
