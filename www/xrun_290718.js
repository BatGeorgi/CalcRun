...
function initContent(data, skipCache) {
	...
	$.each(all, function (i, item) {
		...
		var extLinks = '<input class="hovs hovsMain" title="View full info" type="image" src="extview-icon.png" width="60" height="60" onclick="window.open(\'' + filename + '\', \'_blank\');return false;" />';
